# Encrypt and Decrypt PDF Files Using Csharp

The [Syncfusion PDF Library](https://www.syncfusion.com/document-processing/pdf-framework/net/pdf-library) is a .NET PDF Library that allows users to encrypt and decrypt PDF documents in C# and VB.NET.This repository contains examples of encrypt and decrypt PDF files in C# 
